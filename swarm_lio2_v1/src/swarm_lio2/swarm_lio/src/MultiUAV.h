...
private:
    ...
    int drone_id,min_high_inten_cluster_size, min_cluster_size, min_traj_match_points, cluster_id{0}, lidar_type, actual_uav_num{4};
    double inten_threshold;//浮点数
    vector<Cluster> cluster_pos_tag;
    deque<Vector4d> rejected_static_objects;
